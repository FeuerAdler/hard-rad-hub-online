        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-3xl font-bold text-yellow-500 mb-2">150+</h3>
              <p className="text-gray-600">Aktive Mitglieder</p>
            </div>
            <div className="flex flex-col items-center">
              <Calendar className="h-12 w-12 text-yellow-500 mb-4" />
              <h3 className="text-3xl font-bold text-yellow-500 mb-2">25+</h3>
